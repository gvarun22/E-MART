...
public class ItemUtility {
    ...
    public String getProductName(int productId){
        ...
        String query = " select pr.productName from Product pr where pr.productId like '%" + productId+"%'";
    ...
    public String getProductDescription(int productId){
        ...
        Session s = sessionFactory.openSession();
        Transaction tx = s.beginTransaction();
        String query = " select pr.productDescr from Product pr where pr.productId like '%" + productId+"%'";
    ...
    public float getProductCost(int productId){
       ...
       // Productprices productp;
        ...
        Session s = sessionFactory.openSession();
        Transaction tx = s.beginTransaction();
        String query = "from Productprices prp where prp.product like '%" + product.getProductId()+"%'";
    ...
    public Product getCompleteProduct(int productId){
        ...
        Session s = sessionFactory.openSession();
        Transaction tx = s.beginTransaction();
        String query = "from Product pr where pr.productId like '%" + productId+"%'";
